...
/* ============================================================
   PRICEPOINT ADMIN · MASTER JAVASCRIPT
   Version: 3.0 · Mobile Sidebar Guaranteed Working
   ============================================================ */

// ============================================================
// SIDEBAR TOGGLE - 100% GUARANTEED TO WORK
// ============================================================
...
// ============================================================
// ALSO ATTACH TO ANY ELEMENT WITH data-toggle="sidebar"
// ============================================================
document.addEventListener('click', function(e) {
    var target = e.target.closest('[data-toggle="sidebar"]');
    if (target) {
        e.preventDefault();
        toggleSidebar();
    }
